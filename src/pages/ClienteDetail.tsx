...
import { OFFER_STATUSES, type ClientOffer, type Client } from "@/lib/types";
import { ArrowLeft, Building2, Mail, Phone, MapPin, Plus, FileText, Eye, FolderKanban, UserCircle, Pencil } from "lucide-react";
...
const ClienteDetail = () => {
  ...
  const contacts = mockContacts.filter((ct) => ct.clientId === client.id);
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="stat-card">
          <h2 className="font-semibold mb-4 flex items-center gap-2">
            <UserCircle className="h-4 w-4" /> Contactos
          </h2>
          {contacts.length > 0 ? (
            <div className="space-y-3">
              {contacts.map((ct) => (
